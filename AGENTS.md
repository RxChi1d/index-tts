...
## Active Technologies
- Python >=3.10 + orch/torchaudio, transformers, sentencepiece, indextts (001-add-indextts2-cli)
- 檔案系統（outputs） (001-add-indextts2-cli)

## Recent Changes
- 001-add-indextts2-cli: Added Python >=3.10 + orch/torchaudio, transformers, sentencepiece, indextts
